        ...
        <nav className="relative z-50 flex justify-between items-center px-6 py-6 max-w-[1400px] w-full mx-auto">
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col">
              <span className="text-2xl font-bold tracking-tight leading-none">Lorven<span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400">AI</span></span>
